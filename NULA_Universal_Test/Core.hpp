...
int boardHasBeenConfigured = 120; // This symbolic value
...
WS2812 pixels(1, LEDWS_BUILTIN); // WSLED object
...
/**
 * @brief The setup and test specific for ATMega328 (Dasduino Core)
 *
...
void boardSpecificSetup(uint8_t easyCaddr, unsigned long buttonPressTimeoutMs, unsigned long wifiTimeoutMs)
{
    ...
    int eepromReadValue = EEPROM.read(eepromAddress);
    ...
    Serial.println("Dasduino CORE test begin!");
    delay(20);
    ...
    EEPROM.write(eepromAddress, boardHasBeenConfigured);
}
