...
// Code for NULA Dual (ESP32-C5-WROOM-1)
#pragma once
...
Adafruit_NeoPixel pixels(1, 8); // WSLED object, the NeoPixel is on IO8
...
/**
 * @brief The setup and test specific for NULA Dual (ESP32-C5)
 *
 ...
 * @param wifiTimeoutMs How many ms to wait for the WiFi connection before blocking the code
 */
void boardSpecificSetup(uint8_t easyCaddr, unsigned long buttonPressTimeoutMs, unsigned long wifiTimeoutMs)
{
    ...
    Serial.println("NULA Dual test begin!");
    delay(20);
...
/**
 * @brief Loop function which fades the LED for NULA Dual
 */
